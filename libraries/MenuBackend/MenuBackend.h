...
public:
	...
	inline MenuItem* getSiblingPrev() const { return before; }
	inline MenuItem* getChild() const { return right; }
	inline MenuItem* getSiblingNext() const { return after; }
	inline MenuItem* getParent() const { return left; }
	...
	MenuItem &add(MenuItem &mi) { return addChild(mi); }
	...
	MenuItem &addChild(MenuItem &mi) {
		mi.left = this;
		right = &mi;
		//if ( !mi.back ) mi.back = back;
		return mi;
	}
	MenuItem &addSibling(MenuItem &mi) {
		mi.before = this;
		left = mi.left;
		after = &mi;
		//if ( !mi.back ) mi.back = back;
	...
	MenuItem &addParent(MenuItem &mi) {
		mi.right = this;
		left = &mi;
		//if ( !mi.back ) mi.back = back;
		return mi;
